...
import siragu.shopping.getset.wishlist.Wishpojjo;
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, final int position) {
        ...
        switch (viewType) {
            ...
            default: {
                ...
                ((MyViewHolder) holder).txt_price.setText(context.getString(R.string.dolar) + new DecimalFormat("#0.00").format((int) product.getDiscount()));

...
import siragu.shopping.adapter.ImageAdapter;
import siragu.shopping.getset.Cart.CartPojo;
import siragu.shopping.getset.Detail.Attribute;
import siragu.shopping.getset.Detail.Detailpojo;
import siragu.shopping.getset.Detail.Offers;
import siragu.shopping.getset.Detail.Option;
import siragu.shopping.getset.Detail.Review;
...
import siragu.shopping.utils.WrapContentHeightViewPager;
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        if (detailpojo.getStatus().equals(1)) {
                            ...
                            txt_price.setText(getString(R.string.dolar) + "" + new DecimalFormat("#0.00").format(Double.parseDouble(price)));
                            txt_original.setText(getString(R.string.dolar) + "" + new DecimalFormat("#0.00").format(Double.parseDouble(MRP)));

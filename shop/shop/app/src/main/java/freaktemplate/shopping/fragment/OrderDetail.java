...
import siragu.shopping.adapter.OrderCartAdapter;
import siragu.shopping.getset.OrderDetail.OrderDetails;
import siragu.shopping.getset.OrderDetail.Product;
...
public class OrderDetail extends Fragment {
    ...
    private void inite() {
        ...
        txt_subtotal.setText(getString(R.string.dolar) + new DecimalFormat("#0.00").format(Double.parseDouble(subtotal)));
        txt_delcharge.setText(getString(R.string.dolar) + new DecimalFormat("#0.00").format(Double.parseDouble(del_charge)));
        text_total.setText(getString(R.string.dolar) + new DecimalFormat("#0.00").format(Double.parseDouble(total)));

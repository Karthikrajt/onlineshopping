...
import siragu.shopping.adapter.BrandByAdapter;
import siragu.shopping.adapter.ColorAdapter;
import siragu.shopping.adapter.PriceByAdapter;
import siragu.shopping.adapter.RatingByAdapter;
import siragu.shopping.adapter.SizeByAdapter;
import siragu.shopping.adapter.SortByAdapter;
import siragu.shopping.getset.Filter.Brand;
import siragu.shopping.getset.Filter.Color;
import siragu.shopping.getset.RateGetSet;
import siragu.shopping.getset.refine.Sortbypojjo;
import siragu.shopping.interfaces.CoutomSortbyListner;

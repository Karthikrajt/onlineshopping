...
import siragu.shopping.activity.Categorylist;
import siragu.shopping.adapter.ItemListAdapter;
import siragu.shopping.adapter.ProductAdapter;
import siragu.shopping.adapter.SubCategoryAdapter;
import siragu.shopping.getset.Filter.Brand;
import siragu.shopping.getset.Filter.Color;
import siragu.shopping.getset.Filter.Datum;
import siragu.shopping.getset.Filter.Details;
import siragu.shopping.getset.Filter.FilterPojo;
import siragu.shopping.getset.Filter.Product;
import siragu.shopping.getset.Filter.Subcategory;
...
import siragu.shopping.utils.RecyclerItemClickListener;
        ...
        if (subcategoryList.size() != 0) {
            ...
            recycle_category.addOnItemTouchListener(new RecyclerItemClickListener(context, recycle_category, new RecyclerItemClickListener.OnItemClickListener() {
                ...
                public void onItemClick(View view, int position) {
                    Log.d("CATENAME",""+subcategoryList.get(position).getName());

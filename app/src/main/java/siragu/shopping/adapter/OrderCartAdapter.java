...
public class OrderCartAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ((MyViewHolder) holder).txt_price.setText(context.getString(R.string.dolar) + new DecimalFormat("#0.00").format(Double.parseDouble(orderlist.get(position).getPrice())));

...
public class NormalOfferAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (isProduct.equals("1")) {
            ...
            ((ItemViewHolder) holder).txt_saveup_to.setText(mcontext.getString(R.string.new_price) + " " + mcontext.getString(R.string.dolar) + new DecimalFormat("#0.00").format((int) toplist.getNewPrice()));
        }

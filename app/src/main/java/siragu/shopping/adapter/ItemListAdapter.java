...
import siragu.shopping.getset.bestseling.Productdetail;
        ...
        switch (viewType) {
            ...
            default: {
               try {
                ...
                ((MyViewHolder) holder).txt_price.setText(mcontext.getString(R.string.dolar) + " " + new DecimalFormat("#0.00").format(Double.parseDouble(itemPojjo.getPrice())));
                ((MyViewHolder) holder).txt_original.setText(mcontext.getString(R.string.dolar) + " " + new DecimalFormat("#0.00").format(Double.parseDouble(itemPojjo.getMRP())));

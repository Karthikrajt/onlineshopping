...
import siragu.shopping.activity.OfferActivity;
import siragu.shopping.activity.SearchActivity;
import siragu.shopping.adapter.ItemListAdapter;
import siragu.shopping.adapter.MainOfferAdapter;
import siragu.shopping.adapter.ProductOfferAdapter;
import siragu.shopping.getset.Wish.WishPojo;
import siragu.shopping.getset.bestseling.BestSellingpojo;
import siragu.shopping.getset.bestseling.Data;
import siragu.shopping.getset.bestseling.Datum;
import siragu.shopping.getset.notification.Tokendata;
import siragu.shopping.getset.offerlist.Offer;
import siragu.shopping.getset.offerlist.Offerpojjo;
import siragu.shopping.interfaces.CoutomProductLister;
import siragu.shopping.interfaces.WishlistButtonListener;
import siragu.shopping.utils.AdManager;
import siragu.shopping.utils.SPmanager;
import siragu.shopping.utils.UtilHelper;
import me.relex.circleindicator.CircleIndicator2;
import okhttp3.OkHttpClient;

import static siragu.shopping.activity.HomeActivity.ic_cart;
import static siragu.shopping.activity.HomeActivity.ic_favrite;
import static siragu.shopping.activity.HomeActivity.ic_home;
import static siragu.shopping.activity.HomeActivity.ic_user;
import static siragu.shopping.activity.HomeActivity.rel_cart;
import static siragu.shopping.activity.HomeActivity.rel_favorite;
import static siragu.shopping.activity.HomeActivity.rel_home;
import static siragu.shopping.activity.HomeActivity.rel_user;
import static siragu.shopping.activity.HomeActivity.txt_cart;
import static siragu.shopping.activity.HomeActivity.txt_cartitem;
import static siragu.shopping.activity.HomeActivity.txt_favrite;
import static siragu.shopping.activity.HomeActivity.txt_home;
import static siragu.shopping.activity.HomeActivity.txt_user;
import static siragu.shopping.activity.HomeActivity.txt_wishitem;
import static siragu.shopping.utils.UtilHelper.UNRELIABLE_INTEGER_FACTORY;
...
public class HomeFragment extends Fragment implements View.OnClickListener, BackFragment, CoutomProductLister, WishlistButtonListener {
    ...
    private void getBestsellingList() {
        ...
        AndroidNetworking.get(url)
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    @Override
                    public void onResponse(JSONObject response) {
                        Log.e(TAG, "onResponse11: " + response);
                        try {
    ...
    private void showDialog() {
        ...
        TextView txt_desc = dialog.findViewById(R.id.txt_desc);
        txt_settingtitle.setText(getString(R.string.warning));
        txt_desc.setText(getString(R.string.are_you_sure_you_want_to_exit));
        dialog.show();
